<?php
session_start();
// Встановлення кодування для PHP
...
<div class="admin-content">
    ...
    <div class="content-section">
        ...
        <form method="POST" action="" enctype="multipart/form-data" class="admin-form">
            <div class="form-group">
                ...
                <input type="text" id="title" name="title" value="<?php echo htmlspecialchars($seasonal_promo['title']); ?>" required>
            </div>
            
            <div class="form-group">
                <label for="subtitle">Підзаголовок</label>
                <input type="text" id="subtitle" name="subtitle" value="<?php echo htmlspecialchars($seasonal_promo['subtitle']); ?>" required>
            </div>
            
            <div class="form-group">
                <label for="description">Опис</label>
                <textarea id="description" name="description" rows="3" required><?php echo htmlspecialchars($seasonal_promo['description']); ?></textarea>
            </div>
            
            <div class="form-group">
                <label for="note">Примітка</label>
                <textarea id="note" name="note" rows="2" required><?php echo htmlspecialchars($seasonal_promo['note']); ?></textarea>
            </div>
            
            <div class="form-group">
                <label for="button_text">Текст кнопки</label>
                <input type="text" id="button_text" name="button_text" value="<?php echo htmlspecialchars($seasonal_promo['button_text']); ?>" required>
            </div>
            ...
            <div class="form-group">
                ...
                <?php if (!empty($seasonal_promo['background_image'])): ?>
                    <div class="current-image">
                        <img src="../<?php echo htmlspecialchars($seasonal_promo['background_image']); ?>" alt="Поточний фон" width="300">
                        <p>Поточне фонове зображення</p>
                    </div>
                <?php endif; ?>
                <input type="hidden" name="current_image" value="<?php echo htmlspecialchars($seasonal_promo['background_image']); ?>">
    ...
    <div class="content-section">
        ...
        <div class="preview-container">
            <div class="seasonal-preview">
                <div class="seasonal-content">
                    <h2><?php echo htmlspecialchars($seasonal_promo['title']); ?></h2>
                    <h3><?php echo htmlspecialchars($seasonal_promo['subtitle']); ?></h3>
                    <p><?php echo htmlspecialchars($seasonal_promo['description']); ?></p>
                    <p class="seasonal-note"><?php echo htmlspecialchars($seasonal_promo['note']); ?></p>
                    <button class="btn"><?php echo htmlspecialchars($seasonal_promo['button_text']); ?></button>
                </div>
            </div>
        </div>
    </div>
