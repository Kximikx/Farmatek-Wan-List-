...
<section id="store-info" class="store-info">
    <div class="container">
        <h2 class="section-title">Відвідайте наш магазин</h2>
        <p class="section-subtitle">Приходьте до нашої аптеки, щоб скористатися цими акціями</p>
        ...
        <div class="store-details">
            ...
            <div class="store-info-details">
                <div class="info-card">
                    ...
                    <p><?php echo $store_settings['store_address']; ?></p>
                </div>
                <div class="info-card">
                    <i class="fas fa-clock"></i>
                    <h3>Години роботи</h3>
                    <p><?php echo nl2br($store_settings['working_hours']); ?></p>
                </div>
                <div class="info-card">
                    <i class="fas fa-phone"></i>
                    <h3>Зв'яжіться з нами</h3>
                    <p>Телефон: <?php echo $store_settings['store_phone']; ?><br>
                    Email: <?php echo $store_settings['store_email']; ?></p>
                </div>
                <div class="info-card">
                    <i class="fas fa-info-circle"></i>
                    <h3>Деталі акцій</h3>
                    <p>Всі акції дійсні тільки в магазині.<br>
                    Пропозиції не можуть поєднуватися, якщо не вказано інше.<br>
                    Поки товар є в наявності.</p>
                </div>
            </div>
        </div>
    </div>
